...
class Policy(nn.Module):
    def __init__(self, envs, base_kwargs=None):
        ...
        print("PPO Policy obs_shape: ", obs_shape)
        ...
        print("PPO Policy base hidden (program) dimenstion: ", base_kwargs["hidden_size"])
        self.base = base(obs_shape, **base_kwargs)
        if envs.action_space.__class__.__name__ == "Discrete":
            num_outputs = envs.action_space.n
            self.dist = Categorical(self.base.output_size, num_outputs)
            print("PPO Policy num_outputs: ", num_outputs)
...
class CNNBase(NNBase):
    def __init__(self, obs_shape, recurrent=False, hidden_size=16):
        super(CNNBase, self).__init__(recurrent, hidden_size, hidden_size)
        
        num_inputs, input_height, input_width = obs_shape[0], obs_shape[1], obs_shape[2]
        input_shape = (1, num_inputs, input_height, input_width)
        print("CNNBase input_shape: ", input_shape)
...
class MLPBase(NNBase):
    def __init__(self, obs_shape, recurrent=False, hidden_size=5):
